...
Webserver stack built on top of  [absalomedia/nginx-pagespeed](https://registry.hub.docker.com/u/absalomedia/nginx-pagespeed/), which is built on a [lightly modified Ubuntu Bootstrap image](https://registry.hub.docker.com/u/absalomedia/mini/)
